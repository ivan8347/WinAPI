...
CONST CHAR* g_ITEMS[] = { "Вася","Петя","Маня","Дуня"};
...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInst, LPSTR lpCmdLine, INT nCmdShow)
{
	...
	//hInstance - экземпляр запущенного exe* - файла программы
	//hPrevInst - предедущий экземпляр программы
	//lpCmdLine - командная строка с которой была запущенна программа
...
BOOL CALLBACK DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDC_BUTTON_DEL:
		{
			...
			/*else
			{
				MessageBox(hwnd, "Пожалуйста, выберите элемент для удаления", "Удаление", MB_OK | MB_ICONINFORMATION);
			}*/
		}
		break;
